const translations = {
  ja: {
    heroKicker: 'NO.X RECORD / AI-NATIVE SYSTEMS STUDIO',
    heroStatement: '法人検証基盤、思考プロダクト、開催OS。AIが動く前提で、事業とプロダクトを設計・実装する。',
    proofSystems: 'SYSTEMS BUILT',
    proofLive: 'PUBLICLY LIVE',
    proofPreparing: 'APP STORE PREP',
    discover: 'VIEW SYSTEMS',
    hojinLead: 'AIエージェントに、日本企業を検証する能力を。',
    hojinCopy: '法人番号・インボイス登録・企業情報・住所・営業日。日本の公的データをMCPとRESTで接続し、出典と取得時刻を応答へ埋め込む検証基盤。',
    loopLead: '思考を、成果が生まれる閉回路へ。',
    loopCopy: 'AIとの会話から、記事生成・公開・読者反応・次の会話まで。変換作業をAIへ渡し、人間の判断を連続的なアウトプットへ変える。',
    taisaruLead: 'フットサル開催の段取りを、提案から成立まで一気通貫に。',
    taisaruCopy: 'グループ、招待、日時調整、参加回答、成立自動判定、会場予約記録、支払い管理、通知を統合するiOSアプリ。現在はApp Store公開準備中です。',
    ...
    principle3: '思想を実装し、公開し、現実の制約で検証する。',
    signalTitle: 'BUILD THE<br />NEXT SYSTEM.',
    proposalKicker: 'PARTNERSHIPS / PROJECT INQUIRIES',
    proposalText: 'AIエージェント、業務自動化、AIネイティブなプロダクト設計。共同開発・提携・案件相談の窓口です。',
    startConversation: 'START A CONVERSATION',
    footerLine: 'BECAUSE THE UNKNOWN IS NO LONGER UNKNOWN.'
  },
  en: {
    heroKicker: 'NO.X RECORD / AI-NATIVE SYSTEMS STUDIO',
    heroStatement: 'Corporate verification infrastructure, a thought product, and an event operating system—designed and built around AI as an actor.',
    proofSystems: 'SYSTEMS BUILT',
    proofLive: 'PUBLICLY LIVE',
    proofPreparing: 'APP STORE PREP',
    discover: 'VIEW SYSTEMS',
    hojinLead: 'Give AI agents the ability to verify Japanese companies.',
    hojinCopy: 'Corporate identity, tax registration, profiles, addresses, and business days. Public Japanese data connected through MCP and REST, with source and retrieval time embedded in every response.',
    loopLead: 'Turn thought into a closed loop of outcomes.',
    loopCopy: 'From AI conversation to article generation, publication, audience response, and the next conversation. Transformation moves to AI; human judgment compounds into continuous output.',
    taisaruLead: 'Run a futsal event from proposal to confirmed operation in one flow.',
    taisaruCopy: 'An iOS app unifying groups, invitations, date polling, attendance, automatic confirmation, venue records, payment management, and notifications. App Store release is currently in preparation.',
    ...
    principle3: 'Implement the thesis, publish it, and test it against real constraints.',
    signalTitle: 'BUILD THE<br />NEXT SYSTEM.',
    proposalKicker: 'PARTNERSHIPS / PROJECT INQUIRIES',
    proposalText: 'AI agents, workflow automation, and AI-native product design. Open for selected builds, collaborations, and partnerships.',
    startConversation: 'START A CONVERSATION',
    footerLine: 'BECAUSE THE UNKNOWN IS NO LONGER UNKNOWN.'
  }
};
